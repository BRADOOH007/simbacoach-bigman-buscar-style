  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <meta name="twitter:title" content="Nairobi to Juba Bus | Book Online - SimbaCoach" />
        <meta name="twitter:description" content="Book Nairobi to Juba bus tickets online. Safe, reliable service from Kenya to South Sudan." />
