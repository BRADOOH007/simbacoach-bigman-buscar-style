  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <meta name="twitter:title" content="Nakuru to Kampala Bus: Complete 2025 Travel Guide" />
        <meta name="twitter:description" content="Prices, schedules, Malaba border tips, and how to book your Nakuru to Kampala bus ticket online in 2025." />
