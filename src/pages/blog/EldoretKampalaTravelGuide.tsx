  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <meta name="twitter:title" content="Eldoret to Kampala Bus: Complete 2025 Travel Guide" />
        <meta name="twitter:description" content="Prices, schedules, Malaba border tips, and how to book your Eldoret to Kampala bus ticket online in 2025." />
