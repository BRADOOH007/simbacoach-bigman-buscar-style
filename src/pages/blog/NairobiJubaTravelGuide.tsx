  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <meta name="twitter:title" content="Nairobi to Juba Bus: Complete 2025 Travel Guide" />
        <meta name="twitter:description" content="Prices, schedules, border tips, and how to book your Nairobi to Juba bus ticket online in 2025." />
